...
<html>
  <head>
	...
	-->
	 <body  style="background:url('image/5.png') no-repeat; ">
 ...
 <table width="600" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="1">&nbsp;</td>
    <td width="460" height="1" align="left" class="left_txt">&nbsp;<a href="${pageContext.request.contextPath}/two.jsp"><font color=cracker khaki>返回主页</a></font></td>
  </tr>
