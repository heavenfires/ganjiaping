...
<br><input type="submit" value="提交"/>
  ...
  <tr>
    <td height="1">&nbsp;</td>
    <td width="350" height="1" align="right" class="right_txt">&nbsp;<a href="${pageContext.request.contextPath}/five.jsp"><font color=cracker khaki>返回上一页</a></font></td>
  </tr>
</table> 
 <br>  <table width="450" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="1">&nbsp;</td>
    <td width="350" height="1" align="right" class="right_txt">&nbsp;<a href="${pageContext.request.contextPath}/two.jsp"><font color=cracker khaki>返回主页</a></font></td>
  </tr>
</table> 
  </body>
</html>
