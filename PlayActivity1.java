...
public class PlayActivity1 extends Activity {
  ...
  //      mediaPlayer.start();
       ...
       //修改字体大小，但是我们在这里改了XML里的参数，所以暂时不用这个
        ...
        final Animation translate=AnimationUtils.loadAnimation(PlayActivity1.this, R.anim.translate);
        final Animation rotate=AnimationUtils.loadAnimation(PlayActivity1.this, R.anim.rotate);     
        final Animation alpha=AnimationUtils.loadAnimation(PlayActivity1.this, R.anim.a1);
        PlayActivity1.timu();//两个操作数
